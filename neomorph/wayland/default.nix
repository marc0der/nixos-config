...

{
  ...
  home.file = {
    ...
    ".config/sway/config.d/50-rules-blueman-manager.conf".source = ./sway/config.d/50-rules-blueman-manager.conf;
    ".config/sway/config.d/50-rules-browser.conf".source = ./sway/config.d/50-rules-browser.conf;
    ".config/sway/config.d/50-rules-network-manager.conf".source = ./sway/config.d/50-rules-network-manager.conf;
    ...
    ".config/sway/config.d/60-bindings-media.conf".source = ./sway/config.d/60-bindings-media.conf;
    ".config/sway/config.d/60-bindings-screenshot.conf".source = ./sway/config.d/60-bindings-screenshot.conf;
    ".config/sway/config.d/60-bindings-volume.conf".source = ./sway/config.d/60-bindings-volume.conf;
    ".config/sway/config.d/65-mode-passthrough.conf".source = ./sway/config.d/65-mode-passthrough.conf;
    ".config/sway/config.d/80-xdg-desktop-portal.conf".source = ./sway/config.d/80-xdg-desktop-portal.conf;
    ".config/sway/config.d/90-bar.conf".source = ./sway/config.d/90-bar.conf;
    ".config/sway/config.d/90-swayidle.conf".source = ./sway/config.d/90-swayidle.conf;
    ".config/sway/config.d/95-autostart-policykit-agent.conf".source = ./sway/config.d/95-autostart-policykit-agent.conf;
