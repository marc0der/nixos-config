...
in
{
  ...
  config = mkIf cfg.enable {
    wayland.windowManager.sway.config.keybindings = {
      ...
      # Screenshot controls (simpler versions without Mod key)
      "Print" = "exec ${pkgs.sway-contrib.grimshot}/bin/grimshot save output";
      "Alt+Print" = "exec ${pkgs.sway-contrib.grimshot}/bin/grimshot save active";
      "Ctrl+Print" = "exec ${pkgs.sway-contrib.grimshot}/bin/grimshot save area";
